...
if True:
    ...
    geojson_polygon = r'C:\Users\ecarle\git\CoastSat\examples\Matakana_Island.geojson'
    ...
    if True: 
        ...
        geojson_file = r"C:\Users\ecarle\git\CoastSat\data\MATAKANA_All_1984_2024\matakana_beach_transects.geojson"
    ...
    if False: 
        ...
        filepath = os.fspath(r'C:\Users\ecarle\OneDrive - MetService\Documents\2_Consutancy\projects\tauranga\data\topex_tauranga_1984-2024.csv')
    ...
    if False: 
        ...
        cross_distance = cross_distance.iloc[:, 0:2]
        cross_distance_tidally_corrected = cross_distance_tidally_corrected.iloc[:, 0:2]
        ...
        for i,key in enumerate(cross_distance.keys()):
            ...
            ax.grid(linestyle=':', color='0.5')
            ax.set_ylim([-50,50])
            ax.plot(dates, cross_distance[key]- np.nanmedian(cross_distance[key]), '-o', ms=6, mfc='w', label='raw')
            ax.plot(dates, cross_distance_tidally_corrected[key]- np.nanmedian(cross_distance[key]), '-o', ms=6, mfc='w', label='tidally-corrected')
            ax.set_ylabel('distance [m]', fontsize=12)
            ax.text(0.5,0.95, key, bbox=dict(boxstyle="square", ec='k',fc='w'), ha='center',
                    va='top', transform=ax.transAxes, fontsize=14)
        ax.legend()
        
        #fig.savefig(os.path.join(inputs['filepath'], inputs['sitename'], 'shoreline_change_ts.jpg'),dpi=200)
    ...
    if True:
        ...
        filepath = r"C:\Users\ecarle\git\CoastSat\data\MATAKANA_All_1984_2024\transect_time_series_tidally_corrected.csv"
        ...
        for key in cross_distance.keys():
            ...
            fig.savefig(str(r"C:\Users\ecarle\git\CoastSat\data\MATAKANA_All_1984_2024\output\shoreline_change_transects_season_ts_" + key + ".png"), dpi=200)
        ...
        for key in cross_distance.keys():
            ...
            fig.savefig(str(r"C:\Users\ecarle\git\CoastSat\data\MATAKANA_All_1984_2024\output\shoreline_change_transects_monthly_ts_" + key + ".png"),dpi=200)
